...
namespace TropicalBazaarWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.Role == SD.Role_CompanyUser)
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        //if admin creates an user  then dont logout and signin with that account.
